...
public class swiggyHelpDefinition extends Browser{
	...
	public void user_is_redirected_to_help_and_support_page() throws IOException, InterruptedException {
		...
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\Help page.png");
	}
	...
	public void user_should_be_able_to_resolve_doubts_related_to_partner_onboarding_legal_and_fa_qs() throws InterruptedException, IOException {
		...
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\Partner Onboarding.png");
		help.Legal();
		help.validateLegal();
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\Legal.png");
		help.FAQs();
		help.validateFAQs();
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\FAQs.png");
	}
}
