...
public class swiggySearchDefinition extends Browser{
	...
	public void user_should_be_redirected_to_appropriate_food_result_page() throws IOException, InterruptedException {
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\Food page.png");
		
	}
	@When("User looks for Popular cuisines")
	public void user_looks_for_popular_cuisines() throws IOException, InterruptedException {
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\PopularCuisinesPage.png");
	}
	...
	public void user_should_be_able_to_view_appropriate_restaurants_list_for_that_cuisine() throws InterruptedException, IOException  {
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\cuisinerestuarant.png");
	...
	public void user_click_on_restaurants_and_dishes() throws InterruptedException, IOException {
		...
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\restaurant section.png");
		search.dishesSection();
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\dishes section.png");
	}
	...
	public void appropriate_search_results_should_be_displayed() throws IOException, InterruptedException {
		search.takeScreenshot("C:\\Users\\aavadhoo\\OneDrive - Capgemini\\Desktop\\JUnit\\com.swiggyyy\\Report\\sortBy.png");
